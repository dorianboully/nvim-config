...
return {
  ...
  on_attach = function(_, bufnr)
    ...
    vim.api.nvim_create_user_command("TypstForwardSearch", function() typst.forwardSearch() end, {})
    ...
    vim.keymap.set("n", "<localleader>s", "<cmd>TypstForwardSearch<cr>", { buffer = bufnr, desc = "Forward search (sync PDF page)" })
  end
}
